        ...
        <div className="content-perfil">
          <div className="header-content-perfil">
            ...
            <div className="botoes-avaliacao">
              <button className="btn-avaliacao">
                <img src={Deslike} alt="" />
              </button>
              <button className="btn-avaliacao">
                <img src={Like} alt="" />
          ...
          <div className="postagens-pagina-perfil">
            <div className="header-pagina-postagem">
              <img
                src={FotoPerfilUsuario}
                alt=""
                className="foto-perfil-pagina-perfil"
              />
            ...
            <div className="post-pagina-perfil">
              <p className="mensagem-pagina-perfil">
                Evento muito massa! dei uma caneta no Renatão, mó perna.
                #Ruimdemais
              </p>
              <div className="botoes-pagina-perfil-post">
                <button className="interacao-usuario" id="interacao-usuario">
                  Curtir
                </button>
